...
H.filetype_icons = {
  ...
  antlr4                 = { glyph = '', hl = 'MiniIcons' },
  applescript            = { glyph = '󰀵', hl = 'MiniIconsYellow' },
  asy                    = { glyph = '', hl = 'MiniIcons' },
  authzed                = { glyph = '', hl = 'MiniIcons' },
  bass                   = { glyph = '󰋄', hl = 'MiniIconsBlue' },
  bat                    = { glyph = '󰭟', hl = 'MiniIconsGrey' },
  beancount              = { glyph = '', hl = 'MiniIcons' },
  blade                  = { glyph = '󰫐', hl = 'MiniIconsRed' },
  blueprint              = { glyph = '󰠡', hl = 'MiniIconsBlue' },
  cairo                  = { glyph = '', hl = 'MiniIconsOrange' },
  capnp                  = { glyph = '', hl = 'MiniIcons' },
  cdc                    = { glyph = '󰻫', hl = 'MiniIconsRed' },
  cedar                  = { glyph = '󰐅', hl = 'MiniIconsGreen' },
  cfengine               = { glyph = '󰒓', hl = 'MiniIcons' },
  cook                   = { glyph = '󰆘', hl = 'MiniIcons' },
  coq                    = { glyph = '󱍓', hl = 'MiniIcons' },
  cpon                   = { glyph = '', hl = 'MiniIcons' },
  cqlang                 = { glyph = '', hl = 'MiniIcons' },
  crystal                = { glyph = '', hl = 'MiniIconsGrey' },
  cue                    = { glyph = '󰝚', hl = 'MiniIcons' },
  cypher                 = { glyph = '', hl = 'MiniIcons' },
  dafny                  = { glyph = '', hl = 'MiniIconsYellow' },
  dhall                  = { glyph = '󰏪', hl = 'MiniIcons' },
  earthfile              = { glyph = '', hl = 'MiniIcons' },
  ...
  esdl                   = { glyph = '󰆼', hl = 'MiniIcons' },
  execline               = { glyph = '', hl = 'MiniIcons' },
  factor                 = { glyph = '', hl = 'MiniIcons' },
  faust                  = { glyph = '', hl = 'MiniIcons' },
  firrtl                 = { glyph = '', hl = 'MiniIcons' },
  foam                   = { glyph = '', hl = 'MiniIcons' },
  fsh                    = { glyph = '', hl = 'MiniIcons' },
  func                   = { glyph = '', hl = 'MiniIcons' },
  fusion                 = { glyph = '', hl = 'MiniIcons' },
  glsl                   = { glyph = '', hl = 'MiniIcons' },
  gn                     = { glyph = '', hl = 'MiniIcons' },
  gowork                 = { glyph = '󰟓', hl = 'MiniIconsPurple' },
  hack                   = { glyph = '', hl = 'MiniIcons' },
  handlebars             = { glyph = '󰌞', hl = 'MiniIcons' },
  haskellpersistent      = { glyph = '󰲒', hl = 'MiniIcons' },
  hjson                  = { glyph = '󰘦', hl = 'MiniIconsGreen' },
  hoon                   = { glyph = '', hl = 'MiniIcons' },
  htmlangular            = { glyph = '󰚲', hl = 'MiniIconsRed' },
  httest                 = { glyph = '', hl = 'MiniIcons' },
  indent                 = { glyph = '', hl = 'MiniIcons' },
  inko                   = { glyph = '', hl = 'MiniIconsGreen' },
  janet                  = { glyph = '', hl = 'MiniIconsOrange' },
  ['javascript.glimmer'] = { glyph = '󰌞', hl = 'MiniIconsRed' },
  jsonl                  = { glyph = '󰘦', hl = 'MiniIcons' },
  kdl                    = { glyph = '', hl = 'MiniIcons' },
  larch                  = { glyph = '', hl = 'MiniIcons' },
  lean                   = { glyph = '', hl = 'MiniIcons' },
  ledger                 = { glyph = '󱪹', hl = 'MiniIcons' },
  lilypond               = { glyph = '', hl = 'MiniIcons' },
  liquidsoap             = { glyph = '󰐹', hl = 'MiniIconsPurple' },
  map                    = { glyph = '󰒓', hl = 'MiniIcons' },
  mediawiki              = { glyph = '󰖬', hl = 'MiniIcons' },
  moonscript             = { glyph = '󰽥', hl = 'MiniIconsGrey' },
  move                   = { glyph = '', hl = 'MiniIcons' },
  msmtp                  = { glyph = '󰒓', hl = 'MiniIcons' },
  mustache               = { glyph = '󱗞', hl = 'MiniIcons' },
  norg                   = { glyph = '', hl = 'MiniIconsBlue' },
  nu                     = { glyph = '', hl = 'MiniIconsPurple' },
  pcmk                   = { glyph = '', hl = 'MiniIcons' },
  pem                    = { glyph = '󰌇', hl = 'MiniIcons' },
  pony                   = { glyph = '󱖿', hl = 'MiniIcons' },
  proc                   = { glyph = '󰆼', hl = 'MiniIconsRed' },
  prql                   = { glyph = '󱘻', hl = 'MiniIconsYellow' },
  pug                    = { glyph = '', hl = 'MiniIconsPurple' },
  puppet                 = { glyph = '', hl = 'MiniIconsOrange' },
  pyret                  = { glyph = '', hl = 'MiniIcons' },
  ql                     = { glyph = '󰆼', hl = 'MiniIcons' },
  qmldir                 = { glyph = '󰒓', hl = 'MiniIcons' },
  rbs                    = { glyph = '󰁯', hl = 'MiniIcons' },
  robot                  = { glyph = '󰚩', hl = 'MiniIconsYellow' },
  ron                    = { glyph = '󱘗', hl = 'MiniIconsCyan' },
  rpgle                  = { glyph = '', hl = 'MiniIcons' },
  sage                   = { glyph = '󰘨', hl = 'MiniIconsPurple' },
  sile                   = { glyph = '', hl = 'MiniIcons' },
  smali                  = { glyph = '', hl = 'MiniIconsGrey' },
  smithy                 = { glyph = '', hl = 'MiniIcons' },
  snakemake              = { glyph = '󱔎', hl = 'MiniIconsGreen' },
  sparql                 = { glyph = '', hl = 'MiniIcons' },
  starlark               = { glyph = '', hl = 'MiniIcons' },
  supercollider          = { glyph = '󰆦', hl = 'MiniIconsGrey' },
  surface                = { glyph = '', hl = 'MiniIcons' },
  tablegen               = { glyph = '', hl = 'MiniIcons' },
  tal                    = { glyph = '', hl = 'MiniIcons' },
  teal                   = { glyph = '󰢱', hl = 'MiniIconsCyan' },
  templ                  = { glyph = '', hl = 'MiniIcons' },
  ['terraform-vars']     = { glyph = '󱁢', hl = 'MiniIconsAzure' },
  thrift                 = { glyph = '', hl = 'MiniIcons' },
  tla                    = { glyph = '', hl = 'MiniIcons' },
  trace32                = { glyph = '', hl = 'MiniIcons' },
  turtle                 = { glyph = '󰳗', hl = 'MiniIconsGreen' },
  twig                   = { glyph = '', hl = 'MiniIconsGreen' },
  ['typescript.glimmer'] = { glyph = '󰛦', hl = 'MiniIconsRed'  },
  typespec               = { glyph = '', hl = 'MiniIconsPurple' },
  ungrammar              = { glyph = '󱘎', hl = 'MiniIcons' },
  vala                   = { glyph = '󰬝', hl = 'MiniIconsPurple' },
  vdmpp                  = { glyph = '', hl = 'MiniIconsYellow' },
  vdmrt                  = { glyph = '', hl = 'MiniIconsGreen' },
  vdmsl                  = { glyph = '', hl = 'MiniIconsAzure' },
  vento                  = { glyph = '', hl = 'MiniIconsPurple' },
  vhs                    = { glyph = '󰨛', hl = 'MiniIcons' },
  wgsl                   = { glyph = '', hl = 'MiniIcons' },
  wit                    = { glyph = '', hl = 'MiniIconsCyan' },
  yang                   = { glyph = '', hl = 'MiniIcons' },
  yuck                   = { glyph = '', hl = 'MiniIcons' },
  zimbutempl             = { glyph = '', hl = 'MiniIcons' },
